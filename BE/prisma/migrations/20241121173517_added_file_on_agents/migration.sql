...
*/
-- DropForeignKey
ALTER TABLE "public"."Agent" DROP CONSTRAINT "Agent_photoId_fkey";
...
-- AddForeignKey
ALTER TABLE "Agent" ADD CONSTRAINT "Agent_photoId_fkey" FOREIGN KEY ("photoId") REFERENCES "File"("id") ON DELETE CASCADE ON UPDATE CASCADE;
